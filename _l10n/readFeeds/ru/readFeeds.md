...
### Диалог чтения новостных каналов
...
- Копировать адрес канала: Открывает диалог для подтверждения копирования адреса канала в буфер обмена.
...
- Убран пакет xml, включён в NVDA.
