...
Сообщение следующим образом будет прописано в журнал на уровне информации:
`-- NDTT marker 0 --`
...
* Строка заголовка журнального сообщения содержит функцию, которая зажурналировала это сообщение, например:
