<!--  Translators :
Please do not translate or remove the following  HTML tags:
<br>: newline used in list items
<a name="custom_ID">: used before the titles to be listed in the table of contents

Special hotkeys, automatically detected by the addon:
Grave : In all languages, you must enter the label of the key located above Tab.
Equals : you must always enter the first key to the left of backspace.
minus : fill in the second key to the left of backspace.
See also  keyEquiv.md and adapt it for  the different keyboard layouts  corresponding to your language. Example : Portuguese Portugal, Portuguese Brazil. There are 4 layouts for French.

Links:
Where you see "_en.html" or "-en.html", replace "en" with your language code.

In this english translation, The term "extension" is sometimes used instead of "add-on".
-->
# Thunderbird+
