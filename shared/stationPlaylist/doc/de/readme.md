...
* Es wurden mehrere Probleme bei der Verwendung des Dialogfelds "Spuren einfügen" in Remote Studio behoben, darunter die Meldung "Scan starten" von NVDA beim Drücken von Strg+Umschalt+R und eine ausführliche Ausgabe des Suchergebnisstatus.
