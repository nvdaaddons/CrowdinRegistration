...
* Auteurs: Joseph Lee, Kefas Lungu

Ce module complémentaire offre des gestes supplémentaires pour écran tactile pour NVDA. Il propose également un ensemble de gestes facilitant les déplacements en mode navigation.
