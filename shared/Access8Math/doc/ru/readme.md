...
Эти правила предназначены для улучшения опыта чтения часто используемых математических структур. Система анализирует содержание в соответствии с структурой MathML и математическими правилами, так что выходы речи и выходы Брайля более соответствуют математическому значению. Например, "x^2" будет прочитано как "square of x" вместо "x super 2".
...
Когда система анализирует математические правила, она прочитает их упрощённым образом. Если в математическом содержании есть только один элемент, он может опустить пометки до и после чтения, чтобы его можно было понять более эффективно. Например, "\(\frac{1}{2}\)" будет прочитано как "1 over 2" вместо "fraction with numerator 1 and denominator 2 end fraction".

Включите или отключите упрощенное правило из списка флажков в разделе Настройки > Правила.

#### Паузы между Сегментами

Access8math читает математическое содержимое с паузами между элементами для упрощения понимания математического содержимого.
